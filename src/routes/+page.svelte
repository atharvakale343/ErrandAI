...
<div class="flex h-screen items-center justify-center">
	...
	>
		<div class="address-and-chat-box">
			...
			<div class="fade-in-element chat-box flex flex-row justify-start items-start mx-3 space-x-1 pt-4">
				<div
					contenteditable="true"
					placeholder="Start a conversation with ErrandAI..."
					class="mb-2 w-10/12 rounded-lg border bg-gray-50 p-2 text-xs text-gray-800 shadow-sm shadow-gray-800 placeholder:text-gray-800 focus:placeholder:text-gray-400"
				></div>
				<button
					class="bg-green-700 p-2 h-fit rounded-lg hover:bg-green-600 w-2/12 flex items-center justify-center"
					on:click={() => goto('/grandma')}
				>
					<svg class="w-4 h-8" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="#000000"
		...
		>
			...
			>
				...
				<h1 class="text-xs font-semibold text-green-800">ErrandAI</h1>
			</button>
			<button
