	...
	>
		...
		<div class="chat-box m-3 grow rounded-lg border bg-gray-50 p-2 shadow-sm shadow-gray-800">
			<div class="flex flex-row items-center space-x-2">
				...
				{#if displayed1}
					<h1 class="text-xs" in:typewriter={{ speed: 20 }}>Gettings stores perfect for you...</h1>
				{/if}
			</div>
			{#if displayed2}
				<div class="mt-3 pl-1" in:typewriter={{ speed: 15 }}>
					<h1 class="text-sm font-bold">Grandma's Mocha Vanilla Cake Ingredients</h1>
					<ul class="mt-2 list-disc pl-4 text-sm">
						...
						<li>1 cup Milk (whole milk or buttermilk)</li>
		...
		<div
			...
			class="mx-3 mb-2 rounded-lg border bg-gray-50 p-2 text-xs text-gray-800 shadow-sm shadow-gray-800 placeholder:text-gray-800 focus:placeholder:text-gray-400"
		></div>
